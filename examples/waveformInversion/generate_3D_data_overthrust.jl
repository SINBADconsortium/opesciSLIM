...
using PyCall, PyPlot, HDF5, opesciSLIM.TimeModeling

# Load overthrust model
~isfile("overthrust_3D_true_model.h5") && run(`wget ftp://ftp.slim.gatech.edu/data/SoftwareRelease/WaveformInversion.jl/3DFWI/overthrust_3D_true_model.h5`)
